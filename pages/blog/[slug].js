        ...
        <div class="mx-auto max-w-4xl">
          <div class="">
            ...
            <div class="flex items-center pt-5 md:pt-10">
              <div>
                <img src="/assets/img/blog-author.jpeg"
                  class="h-20 w-20 rounded-full border-2 border-grey-70 shadow"
                  alt="author image" />
              </div>
              <div class="pl-5">
                <span class="block font-body text-xl font-bold text-grey-10">By Mukul Dharashvikar</span>
                <span class="block pt-1 font-body text-xl font-bold text-grey-30">July 11,
                  2022</span>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="w-3/4 sm:w-2/5 lg:w-1/4 xl:w-1/5">
              <img src="/assets/img/blog-author.jpeg" class="rounded-full shadow" alt="author image" />
            </div>
    ...
    <div class="bg-primary">
      <div class="container flex flex-col justify-between py-6 sm:flex-row">
        ...
        <div class="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
          ...
          <a href="https://twitter.com/themukul_99" class="pl-4">
          ...
          <a href="https://www.linkedin.com/in/themukuldharashivkar" class="pl-4">
            <i class="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i>
          </a>
          <a href="https://www.instagram.com/themukulraj" class="pl-4">
